    ...
    messages: [
      {
        ...
        content: [
          ...
          "sourceUrl: obowiązkowo podaj działający link HTTPS.",
          "Dla parków, muzeów, zabytków i miejsc publicznych w Polsce preferuj artykuł pl.wikipedia.org — daje wiarygodne źródło z podglądem.",
          "Dla instytucji z znaną oficjalną stroną możesz podać ją zamiast Wikipedii, ale tylko jeśli jesteś pewien, że domena istnieje.",
          "Nie wymyślaj adresów URL. Pusty string tylko gdy naprawdę brak sensownego źródła.",
